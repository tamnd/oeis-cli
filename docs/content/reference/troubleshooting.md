...
Most of these come down to network reality or how oeis serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

oeis rate-limits like any public site. oeis already paces
...
Where a surface is gated, oeis reads a cookie or token you supply
...
`oeis`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what oeis actually did
